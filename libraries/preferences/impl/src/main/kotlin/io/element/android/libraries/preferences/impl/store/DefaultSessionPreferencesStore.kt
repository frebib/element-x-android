...
class DefaultSessionPreferencesStore(
    ...
    override suspend fun setSkinTone(modifier: String?) = update(skinToneKey, modifier.orEmpty())
    override fun getSkinTone(): Flow<String?> = get(skinToneKey) { "" }.map { it.ifEmpty { null } }
